...
namespace RevitReactionImporter
{
    public class ResultsVisualizer
    {
        ...
        public ResultsVisualizer(Document document)
        {
            ...
            ColorMap.Add(ColorMapCategories.DifferentSizeBeam, new Color(210, 0, 0)); // RED
        ...
        public void ColorMembers(AnalyticalModel model, string annotationToVisualize, List<Beam> mappedRevitBeams, List<Beam> modelBeams)
        {
            ...
            ChooseAnnotationToVisualize(unMappedBeams, nullBeams, userInputBeams, annotationToVisualize);
        ...
        public void ChooseAnnotationToVisualize(List<Beam> unMappedBeams, List<Beam> nullBeams, List<Beam> userInputBeams, string annotationToVisualize)
        {
            ...
            {
                CategorizeSizeValues(unMappedBeams, nullBeams, userInputBeams);
            }
        ...
        // SIZES.
        public void CategorizeSizeValues(List<Beam> unMappedBeams, List<Beam> nullBeams, List<Beam> ramImportBeams)
        {
            // TODO.
        }
